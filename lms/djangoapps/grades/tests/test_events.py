...
class PersistedGradeEventsTest(SharedModuleStoreTestCase, OpenEdxEventsTestMixin):
    """
    ...
    def setUpClass(cls):
        ...
        """
        super(PersistedGradeEventsTest, cls).setUpClass()

    def setUp(self): # pylint: disable=arguments-differ
        super(PersistedGradeEventsTest, self).setUp()
