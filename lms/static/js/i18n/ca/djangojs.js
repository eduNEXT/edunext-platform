...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "%(comments_count)s %(span_sr_open)scomments %(span_close)s": "%(comments_count)s %(span_sr_open)scomentaris %(span_close)s",
    "%(comments_count)s %(span_sr_open)scomments (%(unread_comments_count)s unread comments)%(span_close)s": "%(comments_count)s %(span_sr_open)scomentaris (%(unread_comments_count)s sense llegir comments)%(span_close)s",
    ...
    "Account Settings page.": "P\u00e0gina de configuraci\u00f3 del compte",
    "Action": "Acci\u00f3",
    ...
    "Add a Post": "Afegeix una publicaci\u00f3",
    "Add a Response": "Afegiu una resposta",
    "Add a clear and descriptive title to encourage participation. (Required)": "Afegiu un t\u00edtol clar i descriptiu per fomentar la participaci\u00f3. (Obligatori)",
    ...
    "Add your post to a relevant topic to help others find it. (Required)": "Afegiu la vostra publicaci\u00f3 a un tema rellevant per ajudar-los a trobar-lo. (Obligatori)",
    ...
    "All chapters must have a name and asset": "Tots els cap\u00edtols han de tenir un nom i un actiu",
    ...
    "Allow others to copy, distribute, display and perform only verbatim copies of your work, not derivative works based upon it. This option is incompatible with \"Share Alike\".": "Permetre que altres copien, distribueixin, mostrin i realitzin nom\u00e9s c\u00f2pies literals del vostre treball, i no obres derivades basades en ell. Aquesta opci\u00f3 \u00e9s incompatible amb \"Compartir per igual\".",
    "Allow others to copy, distribute, display and perform your copyrighted work but only if they give credit the way you request. Currently, this option is required.": "Permetre que altres copi\u00efn, distribueixin, mostrin i realitzin el vostre treball protegit per drets d'autor, per\u00f2 nom\u00e9s si donen cr\u00e8dit de la manera que sol\u00b7liciteu. Actualment, aquesta opci\u00f3 \u00e9s obligat\u00f2ria.",
    "Allow others to copy, distribute, display and perform your work - and derivative works based upon it - but for noncommercial purposes only.": "Permetre que altres copi\u00efn, distribueixin, mostrin i realitzeu el vostre treball i els treballs derivats en funci\u00f3 d'ell, per\u00f2 nom\u00e9s amb finalitats no comercials.",
    "Allow others to distribute derivative works only under a license identical to the license that governs your work. This option is incompatible with \"No Derivatives\".": "Permetre que altres distribueixin treballs derivats nom\u00e9s sota una llic\u00e8ncia id\u00e8ntica a la llic\u00e8ncia que regeix el vostre treball. Aquesta opci\u00f3 \u00e9s incompatible amb \"Sense derivats\".",
    ...
    "Any content that has listed this content as a prerequisite will also have access limitations removed.": "Qualsevol contingut que hagi incl\u00f2s aquest contingut com a requisit previ tamb\u00e9 es suprimir\u00e0 les limitacions d'acc\u00e9s.",
    "April": "Abril",
    ...
    "Are you sure you want to delete this page? This action cannot be undone.": "Esteu segur que voleu eliminar aquesta p\u00e0gina? Aquesta acci\u00f3 no es pot desfer.",
    ...
    "Are you sure you want to remove this transcript?": "Esteu segur que voleu eliminar aquesta transcripci\u00f3?",
    ...
    "Are you sure you want to revert to the last published version of the unit? You cannot undo this action.": "Est\u00e0s segur que vols tornar a l'\u00faltima versi\u00f3 publicada de la unitat? No podeu desfer aquesta acci\u00f3.",
    ...
    "Bookmark this page": "Marqueu aquesta p\u00e0gina",
    "Bookmarked": "Marcadors",
    ...
    "Chapter name and asset_path are both required": "El nom del cap\u00edtol i l'asset_path s\u00f3n obligatoris",
    "Chapter name is required": "El nom del cap\u00edtol \u00e9s obligatori",
    ...
    "Choose a location to move your component to": "Trieu una ubicaci\u00f3 per moure el component a",
    "Choose a time": "Escolliu una hora",
    "Choose all": "Escollir-los tots",
    "Choose mode": "Mode d'escollir",
    "Choose new file": "Trieu un fitxer nou",
    ...
    "Course Number:": "N\u00famero de curs:",
    "Course Outline": "Esquema del curs",
    "Course Run:": "Curs en funcionament:",
    ...
    "Created": "Creat",
    "Creating missing groups": "Creant grups que falten",
    ...
    "Delete Page Confirmation": "Suprimeix la confirmaci\u00f3 de la p\u00e0gina",
    ...
    "Delete this {xblock_type} (and prerequisite)?": "Voleu eliminar aquest {xblock_type} (i requisit previ)?",
    "Delete this {xblock_type}?": "Voleu eliminar aquest {xblock_type}?",
    "Deleted Content Group": "Grup de contingut eliminat",
    "Deleted Group": "Grup eliminat",
    "Deleting": "Esborrant",
    "Deleting a textbook cannot be undone and once deleted any reference to it in your courseware's navigation will also be removed.": "Esborrar un llibre de text no es pot desfer i un cop esborrat qualsevol refer\u00e8ncia a ell en el navegador de materials del curs tamb\u00e9 seran eliminats.",
    ...
    "Deleting this {xblock_type} is permanent and cannot be undone.": "Si suprimiu {xblock_type}, \u00e9s permanent i no es pot desfer.",
    "Deprecated": "Obsolet",
    ...
    "Discarding Changes": "Descartant els canvis",
    "Discussion": "Debat",
    "Discussion Home": "P\u00e0gina inicial del debat",
    "Discussion admins, moderators, and TAs can make their posts visible to all students or specify a single group.": "Els administradors de discussi\u00f3, els moderadors i els TA poden fer visibles els seus missatges a tots els estudiants o especificar un sol grup.",
    ...
    "Edit your post below.": "Editeu la publicaci\u00f3 a continuaci\u00f3.",
    "Editing comment": "Editant comentari",
    "Editing post": "Editant publicaci\u00f3",
    "Editing response": "Editant resposta",
    "Editor": "Editor",
    ...
    "Enrollment Tracks": "Seguiment d'inscripcions",
    ...
    "Error importing course": "S'ha produ\u00eft un error en importar el curs",
    ...
    "Error posting your message.": "S'ha produ\u00eft un error en publicar el missatge.",
    ...
    "Error.": "Error.",
    "Error:": "Error:",
    "Error: Choosing failed.": "Error: l'elecci\u00f3 ha fallat.",
    "Error: Connection with server failed.": "Error: la connexi\u00f3 amb el servidor ha fallat.",
    "Error: Import failed.": "Error: la importaci\u00f3 ha fallat.",
    "Error: Replacing failed.": "Error: la substituci\u00f3 ha fallat.",
    "Error: Uploading failed.": "Error: la c\u00e0rrega ha fallat.",
    ...
    "Explicitly Hiding from Students": "Ocultar expl\u00edcitament als estudiants",
    ...
    "File format not supported. Please upload a file with a {ext} extension.": "El format del fitxer no \u00e9s compatible. Carregueu un fitxer amb una extensi\u00f3 {ext}.",
    ...
    "Go Back": "Torna",
    "Go to Dashboard": "Anar al panell d'Admnistraci\u00f3",
    ...
    "Hide Previews": "Amaga les visualitzacions pr\u00e8vies",
    ...
    "Hide notes": "Amaga les notes",
    "Hide transcripts ({transcriptCount})": "Amaga transcripcions ({transcriptCount})",
    "Hiding from Students": "Ocultar-ho als estudiants",
    ...
    "If you remove this transcript, the transcript will not be available for this component.": "Si elimineu aquesta transcripci\u00f3, la transcripci\u00f3 no estar\u00e0 disponible per a aquest component.",
    ...
    "Incorrect url format.": "Format d'URL incorrecte.",
    "Individual Exceptions": "Excepcions individuals",
    "Inheriting Student Visibility": "Her\u00e8ncia de visibilitat dels estudiants",
    "Insert": "Insereix",
    ...
    "Limited Profile": "Perfil limitat",
    "Link types should be unique.": "Els tipus de vincle han de ser \u00fanics.",
    ...
    "Links should be unique.": "Els enlla\u00e7os han de ser \u00fanics.",
    ...
    "Loud": "Alt",
    "Low": "Baix",
    "Make Visible to Students": "Feu que siguin visibles per als estudiants",
    ...
    "More sessions coming soon.": "M\u00e9s sessions properes.",
    "Move": "Moure",
    "Move cancelled. \"{sourceDisplayName}\" has been moved back to its original location.": "Moure cancel\u00b7lat. \"{sourceDisplayName}\" s'ha mogut de nou a la seva ubicaci\u00f3 original.",
    "Move: {displayName}": "Moure: {displayName}",
    "Moving": "Moure",
    ...
    "Need help signing in?": "Necessites ajuda per iniciar sessi\u00f3?",
    "Need other help signing in?": "Necessiteu m\u00e9s ajuda per iniciar la sessi\u00f3?",
    ...
    "OpenAssessment Save Error": "OpenAssessment Guardar Error",
    ...
    "Organization:": "Organitzaci\u00f3:",
    "Other": "Altres",
    "Other sign-in issues": "Altres problemes d'inici de sessi\u00f3",
    ...
    "Please add at least one chapter": "Afegiu com a m\u00ednim un cap\u00edtol",
    ...
    "Please enter your log-in or recovery email address below and we will send you an email with instructions.": "Introdu\u00efu la vostra adre\u00e7a de correu electr\u00f2nic d'inici de sessi\u00f3 o recuperaci\u00f3 a continuaci\u00f3 i us enviarem un correu electr\u00f2nic amb instruccions.",
    ...
    "Please select a file in .srt format.": "Seleccioneu un fitxer en format .srt.",
    "Post": "Publicaci\u00f3",
    ...
    "Professional Education": "Educaci\u00f3 professional",
    "Profile": "Perfil",
    "Profile Image": "Imatge de perfil",
    "Profile Visibility:": "Visibilitat del perfil:",
    "Profile image for {username}": "Imatge de perfil de {username}",
    ...
    "Question": "Pregunta",
    "Questions raise issues that need answers. Discussions share ideas and start conversations. (Required)": "Les preguntes generen problemes que necessiten respostes. Les discussions comparteixen idees i comencen converses. (Required)",
    "Queued": "En cua",
    "REMAINING COURSES": "CURSOS RESTANTS",
    "Re-run Course": "Tornar a fer funcionar un Curs",
    ...
    "Rejected": "Rebutjat",
    "Related to: %(courseware_title_linked)s": "Relacionat amb: %(courseware_title_linked)s",
    ...
    "Remaining": "Continua",
    "Remove": "Eliminar",
    "Remove Transcript": "Elimina la transcripci\u00f3",
    ...
    "Report": "Informar",
    "Report abuse": "Informar d'un ab\u00fas",
    ...
    "Selected blocks": "Blocs seleccionats",
    ...
    "Share": "Compartir",
    "Share Alike": "Compartir per igual",
    ...
    "Show Discussion": "Mostrar debat",
    "Show Previews": "Mostra les visualitzacions pr\u00e8vies",
    ...
    "Showing {currentItemRange} out of {totalItemsCount}, filtered by {assetType}, sorted by {sortName} ascending": "Es mostra {currentItemRange} de {totalItemsCount}, filtrat per {assetType}, ordenat per {sortName} ascendent",
    "Showing {currentItemRange} out of {totalItemsCount}, filtered by {assetType}, sorted by {sortName} descending": "S'est\u00e0 mostrant {currentItemRange} de {totalItemsCount}, filtrat per {assetType}, ordenat per {sortName} de descens",
    "Showing {currentItemRange} out of {totalItemsCount}, sorted by {sortName} ascending": "S'est\u00e0 mostrant {currentItemRange} de {totalItemsCount}, ordenat per {sortName} ascendent",
    "Showing {currentItemRange} out of {totalItemsCount}, sorted by {sortName} descending": "Es mostra {currentItemRange} de {totalItemsCount}, ordenat per {sortName} que descendeix",
    "Sign In": "Accediu",
    ...
    "Subsections": "Subseccions",
    "Success": "\u00c9xit",
    "Success! \"{displayName}\" has been moved.": "\u00c8xit! S'ha mogut \"{displayName}\".",
    ...
    "Take me to the new location": "Porta'm a la nova ubicaci\u00f3",
    ...
    "Teams": "Equips",
    "Terms of Service and Honor Code": "Termes de Servei i Codi d'Honor",
    "Textbook Name": "Nom del llibre de Text",
    "Textbook information": "Informaci\u00f3 del llibre de text",
    "Textbook name is required": "El nom del llibre de text \u00e9s obligatori",
    ...
    "The email address you've provided isn't formatted correctly.": "L'adre\u00e7a de correu que heu proporcionat no t\u00e9 el format correcte.",
    ...
    "The grading process is still running. Refresh the page to see updates.": "El proc\u00e9s d'avaluaci\u00f3 encara s'est\u00e0 executant. Actualitza la p\u00e0gina per a veure les actualitzacions.",
    ...
    "There was an error during the upload process.": "S'ha produ\u00eft un error durant el proc\u00e9s de c\u00e0rrega.",
    ...
    "There was an error while importing the new course to our database.": "S'ha produ\u00eft un error en importar el nou curs a la nostra base de dades.",
    "There was an error while importing the new library to our database.": "S'ha produ\u00eft un error en importar la nova biblioteca a la nostra base de dades.",
    "There was an error while unpacking the file.": "S'ha produ\u00eft un error en desempaquetar el fitxer.",
    "There was an error while verifying the file you submitted.": "S'ha produ\u00eft un error en verificar el fitxer que heu enviat.",
    ...
    "This component has validation issues.": "Aquest component t\u00e9 problemes de validaci\u00f3.",
    ...
    "This may be happening because of an error with our server or your internet connection. Try refreshing the page or making sure you are online.": "Aix\u00f2 pot passar a causa d'un error amb el nostre servidor o la vostra connexi\u00f3 a Internet. Intenteu actualitzar la p\u00e0gina o assegureu-vos que esteu connectat.",
    "This post is visible only to %(group_name)s.": "Aquesta publicaci\u00f3 nom\u00e9s \u00e9s visible per %(group_name)s.",
    "This post is visible to everyone.": "Aquesta publicaci\u00f3 \u00e9s visible per a tothom.",
    "This post will be visible only to %(group_name)s.": "Aquesta publicaci\u00f3 ser\u00e0 visible nom\u00e9s a %(group_name)s.",
    "This post will be visible to everyone.": "Aquesta publicaci\u00f3 ser\u00e0 visible per a tothom.",
    ...
    "This thread is closed.": "Aquest fil est\u00e0 tancat.",
    "This unit has validation issues.": "Aquesta unitat t\u00e9 problemes de validaci\u00f3.",
    "This {parentCategory} has no {childCategory}": "Aquesta {parentCategory} no t\u00e9 {childCategory}",
    "Thumbnail": "Miniatura",
    ...
    "Undo move": "Desf\u00e9s el moviment",
    "Undo moving": "Desf\u00e9s en moviment",
    "Unendorse": "Desaprovar",
    "Unfollow": "No seguir",
    ...
    "Units": "Unitats",
    "Unknown": "Desconegut",
    "Unmark as Answer": "Desmarcar com a Resposta",
    "Unpin": "Torneu a apuntar",
    ...
    "Update comment": "Actualitzar comentari",
    "Update post": "Actualitza la publicaci\u00f3",
    "Update response": "Actualitza resposta",
    "Update team.": "Actualitza un equip",
    "Updating Tags": "Actualitzaci\u00f3 de les etiquetes",
    "Updating with latest library content": "Actualitzar amb contingut de biblioteca m\u00e9s recent",
    ...
    "Upload New File": "Pujar Nou Fitxer",
    ...
    "Vote for this post,": "Vota per a aquesta publicaci\u00f3,",
    "Warning": "Av\u00eds",
    ...
    "Yes, delete this {xblock_type}": "S\u00ed, elimineu aquest {xblock_type}",
    ...
    "You must be over 13 to share a full profile. If you are over 13, make sure that you have specified a birth year on the {account_settings_page_link}": "Per compartir un perfil complet, heu de tenir m\u00e9s de 13 anys. Si tens m\u00e9s de 13 anys, assegureu-vos que heu especificat un any de naixement a {account_settings_page_link}",
    ...
    "You reserve all rights for your work": "Vost\u00e8 es reserva tots els drets per al seu treball",
    "You waive some rights for your work, such that others can use it too": "Vost\u00e8 ren\u00fancia a alguns drets pel seu treball, de manera que els altres tamb\u00e9 ho poden utilitzar",
    ...
    "Your import has failed.": "La importaci\u00f3 ha fallat.",
    "Your import is in progress; navigating away will abort it.": "La vostra importaci\u00f3 est\u00e0 en curs; navegar lluny ho anul\u00b7lar\u00e0.",
    ...
    "Your question or idea (required)": "La vostra pregunta o idea (obligatori)",
    ...
    "anonymous": "an\u00f2nim",
    "answered question": "va respondre la pregunta",
    "asset_path is required": "asset_path \u00e9s obligatori",
    ...
    "discussion": "debat",
    "discussion posted %(time_ago)s by %(author)s": "debat publicat %(time_ago)s per %(author)s",
    ...
    "endorsed %(time_ago)s": "assignat %(time_ago)s",
    "endorsed %(time_ago)s by %(user)s": "assignat %(time_ago)s per %(user)s",
    "enter code here": "entra el codi aqu\u00ed",
    "enter link description here": "entra aqu\u00ed la descripci\u00f3 de l'enlla\u00e7",
    "follow this post": "seguiu aquesta publicaci\u00f3",
    "for": "per",
    "group configuration": "configuraci\u00f3 del grup",
    "incorrect": "incorrecte",
    "internally reviewed": "Revisat internament",
    "less than a minute": "menys d'un minut",
    "marked as answer %(time_ago)s": "marcat com a resposta %(time_ago)s",
    "marked as answer %(time_ago)s by %(user)s": "marcat com a resposta %(time_ago)s per %(user)s",
    "minute": "minut",
    "minutes": "minuts",
    "name": "nom",
    ...
    "post anonymously": "publica de forma an\u00f2nima",
    "post anonymously to classmates": "publica an\u00f2nimament als companys",
    "posted %(time_ago)s by %(author)s": "publicat %(time_ago)s per %(author)s",
    "price": "preu",
    ...
    "question posted %(time_ago)s by %(author)s": "pregunta publicada %(time_ago)s per %(author)s",
    "remove": "eliminar",
    ...
    "subsection": "subsecci\u00f3",
    "text_word_{uniqueId}": "paraula_text_{uniqueId}",
    "text_word_{uniqueId} title_word_{uniqueId}": "paraula_text_{uniqueId} paraula_t\u00edtol_{uniqueId}",
    "title_word_{uniqueId}": "paraula_t\u00edtol_{uniqueId}",
    ...
    "unanswered question": "pregunta sense resposta",
    "unit": "unitat",
    ...
    "{start_strong}{total}{end_strong} words submitted in total.": "{start_strong}{total}{end_strong} paraules enviades en total.",
    "{totalItems} total": "{totalItems} total",
    "{transcriptClientTitle}_{transcriptLanguageCode}.{fileExtension}": "{transcriptClientTitle}_{transcriptLanguageCode}.{fileExtension}",
    "{unread_comments_count} new": "{unread_comments_count} nou",
    "\u2026": "..."
  };
