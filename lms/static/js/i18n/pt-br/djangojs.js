...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Once in position, use the Take Photo button {icon} to capture your ID": "Uma vez posicionado, use o Bot\u00e3o Tirar foto {icon} para capturar sua identidade",
    ...
    "The following information is already a part of your {platform} profile. We've included it here for your application.": "As informa\u00e7\u00f5es a seguir j\u00e1 fazem parte do seu perfil {platform}. N\u00f3s o inclu\u00edmos aqui para o seu aplicativo.",
    ...
    "To take the photo of your face, click on the camera button {icon}. If you need to try again, click 'Retake Photo'.": "Para tirar foto do seu rosto, clique no bot\u00e3o c\u00e2mera {icon}, se precisar tentar novamente, clique 'Tire a foto novamente'. ",
    ...
    "When your face is in position, use the Take Photo button {icon} below to take your photo.": "Quando seu rosto estiver em posi\u00e7\u00e3o, use o bot\u00e3o Tirar foto {icon} abaixo para tirar foto.",
