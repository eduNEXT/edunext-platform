...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "{earned}/{possible} point (graded)": [
      "{earned}/{possible} ponto (avaliado)",
      "{earned}/{possible} pontos (avaliado)"
    ],
    "{earned}/{possible} point (ungraded)": [
      "{earned}/{possible} ponto (n\u00e3o avaliado)",
    ...
    "{num_points} point possible (graded)": [
      ...
      "{num_points} pontos poss\u00edveis (avaliado)"
    ],
    "{num_points} point possible (graded, results hidden)": [
      "{num_points} ponto poss\u00edvel (avaliado, resultados ocultos)",
      "{num_points} pontos poss\u00edveis (avaliado, resultados ocultos)"
    ],
    "{num_points} point possible (ungraded)": [
      "{num_points} ponto poss\u00edvel (n\u00e3o avaliado)",
      "{num_points} pontos poss\u00edveis (n\u00e3o avaliado)"
    ],
    "{num_points} point possible (ungraded, results hidden)": [
      "{num_points} ponto poss\u00edvel (n\u00e3o avaliado, resultados ocultos)",
      "{num_points} pontos poss\u00edveis (n\u00e3o avaliado, resultados ocultos)"
    ],
