...
(function(globals) {
  ...
  var newcatalog = {
    ...
    " learners already appear on the certificate invalidation list": "Aprendizes j\u00e1 aparecem no certificado",
    ...
    "An error occurred while attempting to retrieve or save the information below. Please try again later.": "Um erro ocorreu ao tentar recuperar ou salvar as informa\u00e7\u00f5es abaixo. Por favor tente novamente mais tarde.",
    "An error occurred while looking up team membership. Try refreshing the page.": "Um erro ocorreu enquanto procurava os membros da equipe. Tente atualizar a p\u00e1gina.",
    ...
    "As part of the verification process, you take a photo of both your face and a photo ID. Our authorization service confirms your identity by comparing the photo you take with the photo on your ID.": "Como parte do processo de verifica\u00e7\u00e3o, voc\u00ea tira uma foto de seu rosto e um documento de identidade com foto. Nosso servi\u00e7o de autoriza\u00e7\u00e3o confirma sua identidade comparando a foto que voc\u00ea tirou com a foto em sua identifica\u00e7\u00e3o.",
    ...
    "Check all that apply": "Marque todas a op\u00e7\u00f5es aplic\u00e1veis",
    ...
    "Deleting": "Apagando",
    "Deleting a team is permanent and cannot be undone.All members are removed from the team, and team discussions can no longer be accessed.": "A exclus\u00e3o de uma equipe \u00e9 permanente e n\u00e3o podendo ser desfeita. Todos os membros s\u00e3o removidos da equipe e as discuss\u00f5es da equipe n\u00e3o podem mais ser acessadas.",
    ...
    "Enter your {platform_display_name} username or the URL to your {platform_display_name} page. Delete the URL to remove the link.": "Insira seu nome de usu\u00e1rio do {platform_display_name} ou o URL da sua p\u00e1gina do {platform_display_name}. Delete o URL para remover o link.",
    ...
    "For inquiries regarding assignments, grades, or structure of a specific course, please post in the discussion forums for that course directly.": "Para consultas sobre tarefas, notas ou estrutura de um curso espec\u00edfico, poste nos f\u00f3runs de discuss\u00e3o  para esse curso diretamente.",
    ...
    "Have you ever served on active duty in the U.S. Armed Forces, Reserves, or National Guard?": "Voc\u00ea j\u00e1 serviu na ativa das for\u00e7as armadas, Reserva ou Guarda Nacional dos EUA?",
    "Header": "Cabe\u00e7alho",
    ...
    "If you proceed, you will be unable to use this account to take courses on the {platformName} app, {siteName}, or any other site hosted by {platformName}.": "Se continuar, voc\u00ea ser\u00e1 capaz de usar esta conta para fazer cursos no aplicativo da {platformName}, {siteName}, ou qualquer outro site hospedado pela {platformName}.",
    ...
    "No assignments for team": "Sem atribui\u00e7\u00f5es para a equipe",
    "No color": "Sem cor",
    ...
    "No results found for \"{query_string}\". Please try searching again.": "Resultados n\u00e3o encontrados para \"{query_string}\". Por favor tente pesquisar novamente.",
    ...
    "Once in position, use the Take Photo button {icon} to capture your ID": "Uma vez posicionado, use o Bot\u00e3o Tirar foto {icone} para capturar sua identidade",
    ...
    "Return to my dashboard": "Retornar ao meu painel de controle",
    ...
    "Select current industry": "Selecione a ind\u00fastria atual",
    "Select employment status": "Selecione o status de emprego",
    "Select fidelity": "Selecionar fidelidade",
    "Select gender": "Selecione o g\u00eanero",
    "Select guardian education": "Selecione a educa\u00e7\u00e3o do tutor",
    "Select income": "Selecione a renda",
    "Select language": "Selecionar idioma",
    "Select level of education": "Selecione o n\u00edvel de educa\u00e7\u00e3o ",
    "Select military status": "Selecione o status militar",
    "Select one or more groups:": "Selecione um ou mais grupos:",
    "Select prospective industry": "Selecione a ind\u00fastria em potencial",
    ...
    "Team Assignments": "aprender atribui\u00e7\u00f5es",
    ...
    "Thank you! You\u2019re helping make edX better for everyone.": "Obrigada! Voc\u00ea est\u00e1 ajudando o edX a se tornar melhor para todos.",
    ...
    "The following information is already a part of your {platform} profile. We've included it here for your application.": "As informa\u00e7\u00f5es a seguir j\u00e1 fazem parte do seu perfil {plataforma}. N\u00f3s o inclu\u00edmos aqui para o seu aplicativo.",
    ...
    "The refund deadline for this course has passed, so you will not receive a refund.": "O prazo para reembolso deste curso j\u00e1 terminou, assim, voc\u00ea n\u00e3o receber\u00e1 o reembolso.",
    ...
    "This may be happening because of an error with our server or your internet connection. Try refreshing the page or making sure you are online.": "Isso pode estar acontecendo por causa de um erro com o nosso servidor ou por causa da sua conex\u00e3o de internet. Tente atualizar a p\u00e1gina ou verificar que voc\u00ea realmente esteja online.",
    ...
    "This subsection was released to learners as a special exam, but was reverted back to a basic exam. You may not configure it as a special exam now. Contact edX Support for assistance.": "Essa subse\u00e7\u00e3o foi lan\u00e7ada para o alunos como um  exame especial, mas foi revertida para um exame b\u00e1sico. Voc\u00ea pode configura-lo como um exame especial agora. Entre em contato com o suporte da edX para obter assist\u00eancia.",
    ...
    "To take the photo of your face, click on the camera button {icon}. If you need to try again, click 'Retake Photo'.": "Para tirar foto do seu rosto, clique no bot\u00e3o c\u00e2mera {icone}, se precisar tentar novamente, clique 'Tire a foto novamente'. ",
    ...
    "Unable to submit request to generate report.": "Incapaz de enviar solicita\u00e7\u00e3o para gerar relat\u00f3rio.",
    "Unable to update settings": "N\u00e3o \u00e9 poss\u00edvel atualizar as configura\u00e7\u00f5es",
    "Underline": "Sublinhar",
    "Undo": "Desfazer",
    ...
    "Upload Memberships": "baixar de assinaturas",
    ...
    "Use the Retake Photo button if you are not pleased with your photo": "Use o bot\u00e3o Tirar foto novamente se n\u00e3o estiver contente com a sua foto",
    "Use your webcam to take a photo of your ID.": "Use sua webcam para tirar uma foto de seu documento de identidade",
    ...
    "View Teams in the {topic_name} Topic": "Ver Times no {topic_name} T\u00f3pico",
    ...
    "We securely encrypt your photo and send it to our authorization service for review. Your photo and information are not saved or visible anywhere on %(platformName)s after the verification process is complete.": "Nos criptografamos sua foto com seguran\u00e7a e enviamos para nosso servi\u00e7o de autoriza\u00e7\u00e3o para revis\u00e3o. Sua foto e as informa\u00e7\u00f5es n\u00e3o s\u00e3o salvas ou vis\u00edveis em qualquer lugar em 1%(platformName)s ap\u00f3s o processo de verifica\u00e7\u00e3o esta completo.",
    ...
    "Welcome to edX! Before you get started, please take a few minutes to fill-in the additional information below to help us understand a bit more about your background. You can always edit this information later in Account Settings.": "Bem-vindo ao edX! Antes de come\u00e7ar, reserve alguns minutos para preencher as informa\u00e7\u00f5es adicionais abaixo para nos ajudar a entender um pouco mais sobre sua experi\u00eancia. Voc\u00ea sempre pode editar essas informa\u00e7\u00f5es posteriormente em configura\u00e7\u00f5es de conta. ",
    ...
    "What if I can't see the camera image, or if I can't see my photo do determine which side is visible?": "E se eu n\u00e3o puder ver a imagem da c\u00e2mera, ou se eu n\u00e3o conseguir ver minha foto  determinar qual lado esta visivel?",
    "What if I have difficulty holding my head in position relative to the camera?": "E se tiver dificuldade em manter a minha cabe\u00e7a em posi\u00e7\u00e3o em  rela\u00e7\u00e3o a c\u00e2mera?",
    "What industry do you currently work in?": "Em que setor voc\u00ea trabalha atualmente?",
    "What industry do you want to work in?": "Em  qual setor voc\u00ea deseja trabalhar?",
    "What is the highest level of education that any of your parents or guardians have achieved?": "Qual \u00e9 o n\u00edvel mais alto de educa\u00e7\u00e3o que qualquer um de seus pais ou respons\u00e1vel alcan\u00e7ou?",
    "What is the highest level of education that you have achieved so far?": "Qual  \u00e9 o n\u00edvel mais alto de educa\u00e7\u00e3o que voc\u00ea atingiu ate agora?",
    "What is your gender identity?": "Qual \u00e9 sua identidade de g\u00eanero?",
    "What was the total combined income, during the last 12 months, of all members of your family? ": "Qual foi a renda total combinada durante os \u00faltimos 12 meses,  de todos os membros de sua fam\u00edlia? ",
    ...
    "When your face is in position, use the Take Photo button {icon} below to take your photo.": "Quando seu rosto estiver em posi\u00e7\u00e3o, use o bot\u00e3o Tirar foto {icone} abaixo para tirar foto.",
    "Which of the following describes you best?": "Qual das seguinte op\u00e7\u00f5es descreve melhor voc\u00ea?",
    "Which timed transcript would you like to use?": "Qual transcri\u00e7\u00e3o sincronizada voc\u00ea gostaria de utilizar?",
    "While our support team is happy to assist with the edX platform, the course staff has the expertise for specific assignment questions, grading or the proper procedures in each course. Please post all course related questions within the Discussion Forum where the Course Staff can directly respond.": "Embora nossa equipe  de suporte esteja feliz em ajudar com a plataforma edX, a equipe do curso de experi\u00eancia para quest\u00f5es especificas de de tarefas, notas ou procedimentos adequados em cada curso. Poste todas as perguntas relacionadas ao f\u00f3rum de discuss\u00e3o, onde a equipe do curso pode responder diretamente.",
    ...
    "Why does edX collect this information?": "Porque a edX coleta essas informa\u00e7\u00f5es?",
    "Width": "Largura",
    ...
    "You have selected \u201cDelete my account.\u201d Deletion of your account and personal data is permanent and cannot be undone. {platformName} will not be able to recover your account or the data that is deleted.": "Voc\u00ea selecionou \"Excluir minha conta\". Elimina\u00e7\u00e3o da sua conta e dados pessoais \u00e9 permanente e n\u00e3o pode ser desfeito. {platformName} n\u00e3o ser\u00e1 poss\u00edvel recuperar sua conta ou os dados que s\u00e3o exclu\u00eddos.",
    ...
    "You need a valid ID that contains your full name and photo.": "Voc\u00ea precisa de um documento de identifica\u00e7\u00e3o valido que contenha seu nome completo e foto",
    "You need an ID with your name and photo. A driver's license, passport, or ID are all acceptable.": "Voc\u00ea precisa de um documento de identifica\u00e7\u00e3o com seu nome e foto. Carteira de motorista, passaporte ou documento de identidade s\u00e3o aceitos.",
