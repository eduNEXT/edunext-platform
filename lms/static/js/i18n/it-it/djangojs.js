...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Inheriting Student Visibility": "Eredit\u00e0 visibilit\u00e0 studente ",
    "Inline": "In linea",
    "Insert": "Inserisci",
    ...
    "Making Visible to Students": "Rendere visibile agli studenti ",
    "Manage": "Gestisci",
    ...
    "Student username/email field is required and can not be empty. Kindly fill in username/email and then press \"Invalidate Certificate\" button.": "Il campo nome utente/email dello studente \u00e8 obbligatorio e non pu\u00f2 essere vuoto. Si prega di compilare il nome utente/email e quindi premere il pulsante \"Invalidate Certificate\".",
    ...
    "The minimum grade for course credit is not set.": "Il livello minimo di crediti del corso non \u00e8 impostato.",
    ...
    "You will not receive notification for emails that bounce, so double-check your spelling.": "Per le email respinte non riceverai alcuna notifica, pertanto controlla l'ortografia.",
    ...
    "or": "o",
    "or create a new one here": "o creane uno nuovo qui ",
