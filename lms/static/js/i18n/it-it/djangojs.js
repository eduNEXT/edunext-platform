...
(function(globals) {
  ...
  var newcatalog = {
    ...
    " and ": " e ",
    " learner already appears on the certificate invalidation list": " lo studente \u00e8 gi\u00e0 presente nell'elenco di annullamento del certificato ",
    ...
    " learners already appear on the certificate invalidation list": " gli studenti sono gi\u00e0 presenti nell'elenco di annullamento del certificato ",
    " learners are already white listed and not added to the exception list": " gli studenti sono gi\u00e0 presenti nella lista bianca e non sono stati aggiunti all'elenco delle eccezioni",
    ...
    "%(field)s can only contain up to %(count)d characters.": "%(field)s possono contenere al massimo %(count)d caratteri.",
    "%(field)s must have at least %(count)d characters.": "%(field)s devono contenere almeno %(count)d caratteri.",
    ...
    "(Self-paced) Ended {end}": "(Auto-gestito) Finito {end}",
    "(Self-paced) Ends {end}": "(Auto-gestito) Finisce {end}",
    "(Self-paced) Started {start}": "(Auto-gestito) Iniziato {start}",
    "(Self-paced) Starts {start}": "(Auto-gestito) Inizia {start}",
    "(Staff)": "(Staff)",
    "(optional)": "(facoltativo)",
    ...
    "A Password is required": "E' richiesta una Password",
    ...
    "Accomplishments": "Risultati Ottenuti",
    "Accomplishments Pagination": "Paginazione Risultati Ottenuti",
    "Account": "Account",
    ...
    "Additional posts could not be loaded. Refresh the page and try again.": "Non \u00e8 stato possibile caricare ulteriori post. Aggiorna la pagina e riprova.",
    "Additional responses could not be loaded. Refresh the page and try again.": "Non \u00e8 stato possibile caricare ulteriori risposte. Aggiorna la pagina e riprova.",
    ...
    "An error has occurred. Check your Internet connection and try again.": "Si \u00e8 verificato un errore. Controlla la tua connessione Internet e riprova.",
    ...
    "An error has occurred. Try refreshing the page, or check your Internet connection.": "Si \u00e8 verificato un errore. Prova ad aggiornare la pagina, o controlla la tua connessione Internet.",
    ...
    "Are you sure you want to unenroll from the purchased course {courseName} ({courseNumber})?": "Sei sicuro di voler cancellare la tua iscrizione dal corso acquistato {courseName} ({courseNumber})?",
    ...
    "Checkout": "checkout",
    "Checkout with PayPal": "checkout con PayPal",
    "Checkout with {processor}": "checkout con {processor}",
    "Choose": "Scegli",
    ...
    "Click OK to have your e-mail address sent to a 3rd party application.\n\nClick Cancel to return to this page without sending your information.": "Seleziona OK per inviare il tuo indirizzo e-mail a un'applicazione di 3rd parti. Seleziona Annulla per ritornare a questa pagina senza inviare alcuna informazione.",
    "Click OK to have your username and e-mail address sent to a 3rd party application.\n\nClick Cancel to return to this page without sending your information.": "Clicca OK per inviare il tuo username e indirizzo e-mail ad una applicazione terza.\n\nClicca Cancel per ritornare a questa pagina senza inviare le tue informazioni.",
    "Click OK to have your username sent to a 3rd party application.\n\nClick Cancel to return to this page without sending your information.": "Clicca OK per mandare il tuo username a un'applicazione di 3rd parti.\nClicca Annulla per ritornare indietro a questo pagina senza mandare alcuna informazione.",
    ...
    "Contains staff only content": "Contiene contenuti riservati allo staff",
    ...
    "Could not grade your answer. The submission was aborted.": "Non \u00e8 stato possibile valutare la tua risposta. L'inserimento \u00e8 stato annullato.",
    ...
    "Email": "Email",
    "Email Address (Sign In)": "Indirizzo Email (Accedi)",
    ...
    "Enrollment Tracks": "Tracce iscrizione",
    ...
    "Error generating student profile information. Please try again.": "Errore nella generazione dell'informazione sui profilo degli studenti. Per favore prova un'altra volta.",
    ...
    "Error starting a task to rescore problem '<%- problem_id %>' for student '<%- student_id %>'. Make sure that the the problem and student identifiers are complete and correct.": "Si \u00e8 verificato un errore durante l'avvio del processo di ricalcolo del punteggio del problema '<%- problem_id %>' per lo studente '<%- student_id %>'. Assicurati che gli identificativi del problema e dello studente siano completi e corretti.",
    ...
    "Error: User '<%- username %>' has not yet activated their account. Users must create and activate their accounts before they can be assigned a role.": "Errore: l'Utente '<%- username %>' non ha ancora attivato il proprio account. Gli utenti devono creare e attivare i propri account prima che gli possa essere assegnato un ruolo.",
    "Error: You cannot remove yourself from the Instructor group!": "Errore: Non puoi rimoverti dall gruppo istruttore.",
    "Errors": "Errori",
    ...
    "Files that you upload must be PDFs or image files in .gif, .jpg, .jpeg, or .png format.": "I file che carichi devono essere PDF oppure immagini in formato .gif, .jpg, .jpeg oppure .png.",
    "Files that you upload must be smaller than 5MB in size.": "I file che devi caricare devono essere di dimensioni inferiori di 5MB.",
    ...
    "Go to {platform} Home": "Vai alla Home page di {platform}",
    ...
    "Insert Image (upload file or type URL)": "Inserisci Immagine (carica un file o digita un URL)",
    ...
    "Loading posts list": "Lista di post in caricamento",
    ...
    "No posts matched your query.": "Nessun post corrispondente per i tuoi criteri.",
    ...
    "No results found for {original_query}. Showing results for {suggested_query}.": "Nessun risultato trovato per {original_query}. Sono visualizzati i risultati di {suggested_query}.",
    ...
    "Password assistance": "Assistenza per la password",
    ...
    "Please enter your %(field)s.": "Per cortesia inserisci il tuo %(field)s",
    ...
    "Please fix the following errors:": "Per cortesia correggi i seguenti errori:",
    ...
    "Press UP to enter the speed menu then use the UP and DOWN arrow keys to navigate the different speeds, then press ENTER to change to the selected speed.": "Premi UP per entrare nel men\u00f9 velocit\u00e0 e poi utilizza i tasti freccia UP e DOWN per selezionare le diverse velocit\u00e0, poi premi ENTER per cambiare la velocit\u00e0 selezionata.",
    ...
    "Required": "Richiesto",
    "Required field.": "Campo richiesto",
    "Rescore problem '<%- problem_id %>' for all students?": "Vuoi ricalcolare il punteggio del problema '<%- problem_id %>' per tutti gli studenti?",
    ...
    "Responses could not be loaded. Refresh the page and try again.": "Non \u00e8 stato possibile caricare le risposte. Aggiorna la pagina e riprova.",
    ...
    "Select a course or select \"Not specific to a course\" for your support request.": "Seleziona un corso o seleziona \"Non specifico per un corso\" per la tua richiesta di supporto.",
    ...
    "Select turnaround": "Seleziona restituzione",
    ...
    "Show me other ways to sign in or register": "Mostrami altre modalit\u00e0 di accesso o registrazione",
    ...
    "Showing {firstIndex} out of {numItems} total": "Sono visualizzati {firstIndex} di {numItems} totali",
    "Showing {firstIndex}-{lastIndex} out of {numItems} total": "Sono visualizzati {firstIndex}-{lastIndex} di {numItems} totali",
    "Sign In": "Accedi",
    "Sign in": "Accedi",
    ...
    "Sign in to {platform} so we can help you better.": "Accedi a {platform} cos\u00ec potremo aiutarti meglio.",
    ...
    "Something went wrong changing this enrollment. Please try again.": "Qualcosa \u00e8 andato storto nel cambiare questa iscrizione. Per cortesia riprova.",
    "Something went wrong. Please try again later.": "Qualcosa \u00e8 andato storto. Per cortesia riprova pi\u00f9 tardi.",
    ...
    "Started entrance exam rescore task for student '{student_id}'. Click the 'Show Task Status' button to see the status of the task.": "E' stato avviato il processo di ricalcolo del punteggio dell'esame di ammissione per lo studente '{student_id}'. Fai clic sul pulsante 'Mostra Stato Processo' per vedere lo stato di avanzamento del processo.",
    "Started rescore problem task for problem '<%- problem_id %>' and student '<%- student_id %>'. Click the 'Show Task Status' button to see the status of the task.": "E' stato avviato il processo di ricalcolo del punteggio del problema '<%- problem_id %>' e dello studente '<%- student_id %>'. Fai clic sul pulsante 'Mostra Stato Processo' per vedere lo stato di avanzamento del processo.",
    ...
    "Student username/email field is required and can not be empty. Kindly fill in username/email and then press \"Add to Exception List\" button.": "Il campo nome utente/email dello studente \u00e8 obbligatorio e non pu\u00f2 essere vuoto. Si prega di compilare il nome utente/e-mail e quindi premere il pulsante \"Aggiungi all'elenco delle eccezioni\".",
    "Student username/email field is required and can not be empty. Kindly fill in username/email and then press \"Invalidate Certificate\" button.": "Il campo nome utente/email dello studente \u00e8 obbligatorio e non pu\u00f2 essere vuoto. Si prega di compilare il nome utente/e-mail e quindi premere il pulsante \"Invalida Certificato\".",
    "Studio's having trouble saving your work": "Studio ha problemi a salvare i tuoi progressi.",
    "Studio:": "Studio:",
    "Style": "Stile",
    "Subject": "Oggetto",
    "Subject:": "Oggetto:",
    "Submission aborted! Sorry, your browser does not support file uploads. If you can, please use Chrome or Safari which have been verified to support file uploads.": "Inserimento annullato! Ci dispiace, il tuo browser non supporta il caricamento di file. Se possibile, utilizzate Chrome o Safari per i quali \u00e8 stato accertato che supportano il caricamento di file.",
    "Submit": "Invia",
    ...
    "Success! Problem attempts reset for problem '<%- problem_id %>' and student '<%- student_id %>'.": "Successo! Tentativi di risoluzione problema reimpostati per il problema '<%- problem_id %>' e lo studente '<%- student_id %>'.",
    ...
    "Successfully started task to rescore problem '<%- problem_id %>' for all students. Click the 'Show Task Status' button to see the status of the task.": "E' stato avviato con successo il processo di ricalcolo del punteggio del problema '<%- problem_id %>' per tutti gli studenti. Fai clic sul pulsante 'Mostra Stato Processo' per vedere lo stato di avanzamento del processo.",
    ...
    "Take a photo of your ID": "Fai una foto del tuo documento d'ID",
    ...
    "Teaching Assistant": "Assistente Didattico",
    ...
    "Thank you for submitting a request! We appreciate your patience while we work to review your request.": "Grazie per aver inviato una richiesta! Apprezziamo la tua pazienza mentre lavoriamo per esaminare la tua richiesta.",
    ...
    "The post you selected has been deleted.": "Il post che hai selezionato \u00e8 stato cancellato.",
    ...
    "There's already another assignment type with this name.": "Esiste gi\u00e0 un tipo di esercizio con questo nome",
    ...
    "This comment could not be deleted. Refresh the page and try again.": "Non \u00e8 stato possibile cancellare questo commento. Aggiorna la pagina e riprova.",
    ...
    "This discussion could not be loaded. Refresh the page and try again.": "Non \u00e8 stato possibile caricare questa discussione. Aggiorna la pagina e riprova.",
    ...
    "This post could not be closed. Refresh the page and try again.": "Non \u00e8 stato possibile chiudere questo post. Aggiorna la pagina e riprova.",
    "This post could not be flagged for abuse. Refresh the page and try again.": "Non \u00e8 stato possibile segnalare questo post per abuso. Aggiorna la pagina e riprova.",
    "This post could not be pinned. Refresh the page and try again.": "Non \u00e8 stato possibile appuntare questo post. Aggiorna la pagina e riprova.",
    "This post could not be reopened. Refresh the page and try again.": "Non \u00e8 stato possibile riaprire questo post. Aggiorna la pagina e riprova.",
    "This post could not be unflagged for abuse. Refresh the page and try again.": "Non \u00e8 stato possibile annullare la segnalazione per abuso di questo post. Aggiorna la pagina e riprova.",
    "This post could not be unpinned. Refresh the page and try again.": "Non \u00e8 stato possibile sbloccare questo post. Aggiorna la pagina e riprova.",
    ...
    "This response could not be marked as an answer. Refresh the page and try again.": "Non \u00e8 stato possibile contrassegnare questo inserimento come risposta. Aggiorna la pagina e riprova.",
    ...
    "This response could not be unendorsed. Refresh the page and try again.": "Non \u00e8 stato possibile annullare l'approvazione di questa risposta. Aggiorna la pagina e riprova.",
    "This response could not be unmarked as an answer. Refresh the page and try again.": "Non \u00e8 stato possibile annullare la contrassegnazione come risposta di questo inserimento. Aggiorna la pagina e riprova.",
    ...
    "This vote could not be processed. Refresh the page and try again.": "Non \u00e8 stato possibile elaborare questo voto. Aggiorna la pagina e riprova.",
    ...
    "Upgrade Deadline": "Scadenza dell'aggiornamento",
    ...
    "Upset Learner": "Studente Sconvolto",
    "Url": "Url",
    ...
    "Verification Deadline": "Scadenza della verifica",
    ...
    "Video position. Press space to toggle playback": "Posizione video. Premi spazio per avviare/fermare la riproduzione",
    ...
    "View child items": "Visualizza gli elementi figlio",
    ...
    "Visible to Staff Only": "Visibile solamente allo Staff",
    ...
    "Warning": "Allerta",
    "Warnings": "Problemi",
    "We ask you to activate your account to ensure it is really you creating the account and to prevent fraud.": "Ti chiediamo di attivare il tuo account per assicurarci che sei davvero tu a creare l'account e per prevenire le frodi. ",
    ...
    "We couldn't sign you in.": "Non siamo riusciti a farti accedere.",
    ...
    "While our support team is happy to assist with the edX platform, the course staff has the expertise for specific assignment questions, grading or the proper procedures in each course. Please post all course related questions within the Discussion Forum where the Course Staff can directly respond.": "Sebbene il nostro team di supporto sia lieto di assistere con la piattaforma edX, lo staff del corso ha l'esperienza necessaria per rispondere a specifiche domande sul compito, valutazioni o procedure appropriate in ogni corso. Pubblica tutte le domande relative al corso all'interno del Forum di Discussione dove lo Staff del Corso potr\u00e0 rispondere direttamente.",
    ...
    "You could not be subscribed to this post. Refresh the page and try again.": "Non \u00e8 stato possibile iscriverti a questo post. Aggiorna la pagina e riprova.",
    ...
    "You did not select any files to submit.": "Non hai selezionato alcun file da caricare.",
    "You did not submit the required files: {requiredFiles}.": "Non hai caricato i file richiesti: {requiredFiles}.",
    ...
    "You submitted {filename}; only {allowedFiles} are allowed.": "Ha caricato {filename}; solamente {allowedFiles} sono permessi.",
    ...
    "Your file {filename} is too large (max size: {maxSize}MB).": "Il tuo file {filename} \u00e8 troppo grande (dimensione massima: {maxSize}MB).",
    ...
    "Your request could not be completed. Reload the page and try again. If the issue persists, click the Help tab to report the problem.": "Non \u00e8 stato possibile completare la tua richiesta. Ricarica la pagina e riprova. Se il problema persiste, clicca la scheda Help per inviare una segnalazione.",
    ...
    "dropped in slider": "cursore inserito",
    "dropped on target": "rilasciato sull'obiettivo",
    "e.g. 'Sky with clouds'. The description is helpful for users who cannot see the image.": "ad es. 'Cielo con nuvole'. La descrizione \u00e8 utile agli utenti che non possono vedere l'immagine.",
    ...
    "{htmlStart}Want to change your email, name, or password instead?{htmlEnd}": "{htmlStart}Vuoi forse cambiare invece la tua email, il nome, o la password?{htmlEnd}",
    ...
    "{start_strong}{total}{end_strong} words submitted in total.": "{start_strong}{total}{end_strong} parole immesse in totale.",
