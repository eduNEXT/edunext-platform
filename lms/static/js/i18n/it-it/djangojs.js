...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "File": "File", 
    "File Name": "Nome File", 
    "File size must be 5MB or less.": "La dimensione del file deve essere 5MB o inferiore.", 
    ...
    "Image alternative text": "Testo alternativo per l'immagine", 
    "Image description": "Descrizione dell'immagine", 
    ...
    "You can make limited use of Markdown in answer texts, preferably only bold and italics.": "Puoi usare in modo limitato la sintassi Markdown nel testo delle risposta, preferibilmente solo grassetto e corsivo si possono utilizzare.", 
