...
(function (globals) {
  ...
  django.catalog = {
    ...
    "All flags have been removed. To undo, uncheck the box.": "Tutti i flag sono stati rimossi. Per annullare l'operazione, deseleziona la scatola.", 
    ...
    "Annotation Text": "Testo dell'annotazione", 
    ...
    "Check the box to remove %(count)s flag.": [
      "Seleziona il box per rimuover %(count)s flag.", 
      "Seleziona il box per rimuovere %(count)s flag."
    ], 
    "Check the box to remove %(totalFlags)s flag.": [
      "Seleziona il box per rimuovere %(totalFlags)s flag.", 
      "Seleziona il box per rimuover %(totalFlags)s flags."
    ], 
    "Check the box to remove all flags.": "Seleziona il box per rimuovere tutti i flags.", 
    ...
    "Could not parse certificate JSON. %(message)s": "Imposibbile analizzare il certificato JSON. %(message)s", 
    ...
    "Date posted": "Data postata", 
    "Decrease indent": "Riduci indentazione", 
    "Default": "Predefinito", 
    "Delete": "Cancella", 
    "Delete \"<%= signatoryName %>\" from the list of signatories?": "Cancella \"<%= signatoryName %>\" dalla lista dei firmatari?", 
    ...
    "Drag and drop or click here to upload video files.": "Trascina o clicca qui per trasmettere i files video.", 
    ...
    "Editing: %(title)s": "Modifica in corso: %(title)s", 
    "Editor": "Editore", 
    ...
    "Paragraph": "Paragrafo", 
    "Password": "Password", 
    "Password reset email sent. Follow the link in the email to change your password.": "Email per rispristino della password inviata. Segui il link nell'email per cambiare la tua password.", 
    "Paste": "Incolla", 
    ...
    "Please check your email to confirm the change": "Per favore, controlla la tua email per confermare il cambiamento", 
    ...
    "Report annotation as inappropriate or offensive.": "Segnala annotazione come innappropriata o offensiva.", 
    ...
    "The data could not be saved.": "Impossibile salvare i dati.", 
    "The email address you use to sign in. Communications from {platform_name} and your courses are sent to this address.": "Indirizzo email utilizzato per la registrazione. Le comunicazioni da {platform_name} e dai tuoi corsi vengono inviate a questo indirizzo.", 
    ...
    "The language used throughout this site. This site is currently available in a limited number of languages.": "Lingua usata in questo sito. Questo sito \u00e8 attualmente disponibile in un numero limitato di lingue.", 
    "The name that identifies you throughout {platform_name}. You cannot change your username.": "Nome che ti identifica in tutta {platform_name}. Non \u00e8 possibile modificare il nome utente.", 
    ...
    "This annotation has %(count)s flag.": [
      "Questa annotazione presenta %(count)s flag.", 
      "Questa annotazione presenta %(count)s flag."
    ], 
    ...
    "We weren't able to send you a password reset email.": "Non siamo stati in grado di inviarti una email per il ripristino password.", 
    ...
    "You have already reported this annotation.": "Hai gi\u00e0 segnalato questa annotazione.", 
    ...
    "{platform_name} learners can see my:": "{platform_name} gli studenti possono vedere il mio:", 
    "\u2026": "..."
  };
