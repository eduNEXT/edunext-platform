...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Delete column": "\u522a\u9664\u884c",
    "Delete row": "\u522a\u9664\u5217",
    "Delete student '<%- student_id %>'s state on problem '<%- problem_id %>'?": "\u5728 '<%- problem_id %>'?\u554f\u984c\u522a\u9664\u5b78\u751f\u7684\u72c0\u614b '<%- student_id %>'",
    "Delete table": "\u522a\u9664\u8868\u683c",
    ...
    "Error starting a task to override score for problem '<%- problem_id %>' for student '<%- student_id %>'. Make sure that the the score and the problem and student identifiers are complete and correct.": "\u53d6\u4ee3\u76f8\u95dc\u984c\u76ee'<%- problem_id %>'\u548c\u5b78\u751f\u7684\u5206\u6578'<%- student_id %>'\u6642\u5019\u767c\u751f\u932f\u8aa4\u3002\u78ba\u4fdd\u76f8\u95dc\u984c\u76ee\uff0c\u5b78\u751f\u8cc7\u6599\u548c\u5b78\u751f\u7684\u5206\u6578\u6b63\u78ba\u800c\u5b8c\u6574\u3002",
    ...
    "Error starting a task to rescore problem '<%- problem_id %>'. Make sure that the problem identifier is complete and correct.": "\u8abf\u6574\u554f\u984c'<%- problem_id %>'\u6642\u51fa\u73fe\u932f\u8aa4\u3002\u8acb\u78ba\u8a8d\u554f\u984c\u8fa8\u8b58\u78bc\u7684\u8cc7\u8a0a\u5b8c\u6574\u4e14\u6b63\u78ba\u3002",
    ...
    "Started task to override the score for problem '<%- problem_id %>' and student '<%- student_id %>'. Click the 'Show Task Status' button to see the status of the task.": "\u6b63\u5728\u958b\u59cb\u53d6\u4ee3\u76f8\u95dc\u984c\u76ee'<%- problem_id %>'\u548c\u5b78\u751f\u7684\u5206\u6578'<%- student_id %>'\u3002\u9ede\u64ca'\u986f\u793a\u4efb\u52d9\u72c0\u614b'\u6309\u9215\u4f86\u770b\u4efb\u52d9\u7684\u9032\u5ea6\u3002",
    ...
    "Successfully started task to rescore problem '<%- problem_id %>' for all students. Click the 'Show Task Status' button to see the status of the task.": "\u5df2\u7d93\u6210\u529f\u958b\u59cb\u91cd\u65b0'<%- problem_id %>'\u8a55\u91cf\u6240\u6709\u5b78\u751f\u3002\u9ede\u9078\u300c\u986f\u793a\u4efb\u52d9\u72c0\u614b\u300d\u67e5\u770b\u8655\u7406\u72c0\u614b\u3002",
    ...
    "You may also lose access to verified certificates and other program credentials like MicroMasters certificates. If you want to make a copy of these for your records before proceeding with deletion, follow the instructions for {htmlStart}printing or downloading a certificate{htmlEnd}.": "\u60a8\u4e5f\u53ef\u80fd\u7121\u6cd5\u8a2a\u554f\u5df2\u9a57\u8b49\u7684\u8b49\u66f8\u548c\u5176\u4ed6\u7a0b\u5e8f\u6191\u64da\uff0c\u4f8b\u5982MicroMasters\u8b49\u66f8\u3002 \u5982\u679c\u8981\u5728\u522a\u9664\u4e4b\u524d\u8907\u88fd\u9019\u4e9b\u8a18\u9304\uff0c\u8acb\u6309\u7167{htmlStart}\u6253\u5370\u6216\u4e0b\u8f09\u8b49\u66f8{htmlEnd}\u7684\u6307\u793a\u9032\u884c\u64cd\u4f5c\u3002",
