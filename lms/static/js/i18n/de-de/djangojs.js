...
(function(globals) {
  ...
  var newcatalog = {
    ...
    " as many questions may have already been answered.": " so viele Fragen sind vielleicht schon beantwortet worden.",
    " learner already appears on the certificate invalidation list": "Der Teilnehmer ist auf der Zertifikatsentwertungsliste",
    ...
    " learners already appear on the certificate invalidation list": "Ddie Teilnehmer sind bereits auf der Zertifikatsentwertungsliste",
    ...
    "%(field)s must have at least %(count)d characters.": "%(field)s muss mindestens %(count)d Zeichen enthalten.",
    ...
    "(contains %(student_count)s student)": [
      "(enth\u00e4lt %(student_count)s Teilnehmer)",
      "(enth\u00e4lt %(student_count)s Teilnehmer)"
    ],
    "(optional)": "(optional)",
    "(required)": "(*)",
    ...
    "Access to this unit is restricted to: {selectedGroupsLabel}": "Der Zugriff auf dieses Ger\u00e4t ist beschr\u00e4nkt auf: {selectedGroupsLabel}",
    ...
    "Activating a link in this group will skip to the corresponding point in the video.": "Das Einf\u00fcgen eines Links hier f\u00fchrt zu der entsprechenden Stelle im Video.",
    "Active": "Aktiv",
    ...
    "Adjust video speed": "Videogeschwindigkeit anpassen",
    "Adjust video volume": "Videolautst\u00e4rke anpassen",
    "Admin": "Administrator",
    "Advanced": "Erweitert",
    ...
    "Allow others to copy, distribute, display and perform only verbatim copies of your work, not derivative works based upon it. This option is incompatible with \"Share Alike\".": "Erlauben Sie anderen, nur wortgetreue Kopien Ihres Werkes zu kopieren, zu verteilen, anzuzeigen und auszuf\u00fchren, keine abgeleiteten Werke, die darauf basieren. Diese Option ist nicht mit \"Share Alike\" kompatibel.",
    "Allow others to copy, distribute, display and perform your copyrighted work but only if they give credit the way you request. Currently, this option is required.": "Erlauben Sie anderen, Ihr urheberrechtlich gesch\u00fctztes Werk zu kopieren, zu verteilen, anzuzeigen und auszuf\u00fchren, aber nur, wenn sie auf die von Ihnen gew\u00fcnschte Art und Weise Verweise geben. Derzeit ist diese Option erforderlich.",
    ...
    "Are you sure you want to delete this post?": "M\u00f6chten Sie den Beitrag wirklich l\u00f6schen?",
    "Are you sure you want to delete this response?": "M\u00f6chten Sie diese Antwort wirklich l\u00f6schen?",
    ...
    "August": "August",
    "Author": "Autor",
    "Auto-advance": "Automatischer Fortschritt",
    ...
    "Before proceeding, please {htmlStart}unlink all social media accounts{htmlEnd}.": "Bevor Sie fortfahren, {htmlStart}entfernen{htmlEnd} Sie bitte alle Verlinkungen zu jedem Social Media Konto.",
    ...
    "Chapter name and asset_path are both required": "Kapitelname und asset_path sind erforderlich",
    ...
    "Check all that apply": "Alles, was zutrifft ausw\u00e4hlen",
    ...
    "Click OK to have your e-mail address sent to a 3rd party application.\n\nClick Cancel to return to this page without sending your information.": "Kilcken Sie auf OK, um Ihre E-Mail-Adresse an eine 3.Anwendung weiterzuleiten.\n\nKlicken Sie auf Abbrechen, um zu dieser Seite zur\u00fcckzukehren ohne Daten zu senden.",
    "Click OK to have your username and e-mail address sent to a 3rd party application.\n\nClick Cancel to return to this page without sending your information.": "Kilcken Sie auf OK, um Ihren Nutzernamen und Ihre E-Mail-Adresse an eine 3.Anwendung weiterzuleiten.\n\nKlicken Sie auf Abbrechen, um zu dieser Seite zur\u00fcckzukehren ohne Daten zu senden.",
    "Click OK to have your username sent to a 3rd party application.\n\nClick Cancel to return to this page without sending your information.": "Kilcken Sie auf OK, um Ihren Nutzernamen an eine 3.Anwendung weiterzuleiten.\n\nKlicken Sie auf Abbrechen, um zu dieser Seite zur\u00fcckzukehren ohne Daten zu senden.",
    "Click on this button to mute or unmute this video or press UP or DOWN buttons to increase or decrease volume level.": "Klicken Sie auf diesen Knopf, um das Video stumm oder auf laut zu schalten. Dr\u00fccken Sie die Pfeiltasten HOCH oder RUNTER um die Lautst\u00e4rke zu ver\u00e4ndern.",
    ...
    "Collapse Instructions": "Anleitung verbergen",
    ...
    "Could not find the specified string.": "Diese Zeichenkette konnte nicht gefunden wurden.",
    ...
    "Could not grade your answer. The submission was aborted.": "Ihre Antwort konnte nicht benotet werden. Der Vorgang wurde abgebrochen.",
    ...
    "Created": "Erstellt",
    "Creating missing groups": "Fehlende Gruppen erstellen",
    ...
    "Deleting a textbook cannot be undone and once deleted any reference to it in your courseware's navigation will also be removed.": "Das L\u00f6schen eines Textbooks kann nicht r\u00fcckg\u00e4ngig gemacht werden. Au\u00dferdem werden alle Referenzen auf das Textbuch in der Kursinhaltsnavigation auch gel\u00f6scht.",
    ...
    "Due to the recent increase in interest in online education and edX, we are currently experiencing an unusually high volume of support requests. We appreciate your patience as we work to review each request. Please check the ": "Aufgrund des in letzter Zeit gestiegenen Interesses an Online-Schulungen und an edX erleben wir derzeit ein ungew\u00f6hnlich hohes Volumen an Support-Anfragen. Wir wissen Ihre Geduld zu sch\u00e4tzen, w\u00e4hrend wir jede Anfrage pr\u00fcfen. Bitte pr\u00fcfen Sie die ",
    "Due:": "Bis:",
    ...
    "End of transcript. Skip to the start.": "Ende des Transkriptes. Zur\u00fcck zum Anfang springen",
    "Endorse": "Bef\u00fcrworten",
    ...
    "Exit full browser": "Vollbild verlassen",
    "Expand All": "Alles erweitern",
    "Expand Instructions": "Anleitung anzeigen",
    ...
    "Find": "Suchen",
    "Find a course": "Suche nach einen Kurs",
    ...
    "Go Back": "Gehe zur\u00fcck",
    "Go to Dashboard": "Gehe zu \"Meine Kurse\"",
    ...
    "Hide": "Ausblenden",
    "Hide Annotations": "Anmerkungen verbergen",
    ...
    "Last Updated": "Letzte \u00dcberarbeitung",
    ...
    "Load all responses": "Alle Antworten laden",
    "Load more": "Lade weiteres",
    "Load next {numResponses} responses": "Die n\u00e4chsten {numResponses} Antworten laden ",
    ...
    "Next": "Weiter",
    "Next: %(nextStepTitle)s": "N\u00e4chster Schritt: %(nextStepTitle)s",
    ...
    "Paste is now in plain text mode. Contents will now be pasted as plain text until you toggle this option off.": "Einf\u00fcgen im reinen Textmodus. Alle Inhalte werden ab jetzt als reiner Text eingef\u00fcgt, bis diese Option deaktiviert wird.",
    "Paste row after": "Zeile danach einf\u00fcgen",
    "Paste row before": "Zeile davor einf\u00fcgen",
    "Paste your embed code below:": "Eingebetteten Code unten einf\u00fcgen:",
    ...
    "Rich Text Area. Press ALT-F9 for menu. Press ALT-F10 for toolbar. Press ALT-0 for help": "Rich-Text-Area. Dr\u00fccke ALT-F9, um das Men\u00fc zu \u00f6ffnen. Dr\u00fccke ALT-F10, um die Werkzeugleiste zu \u00f6ffnen. Dr\u00fccke ALT-0, um Hilfe anzufordern",
    "Right": "Rechts",
    ...
    "Section {currentPage} of {totalPages}": "Einheit {currentPage} von {totalPages}",
    "Sections": "Abschnitte",
    "Security": "Sicherheit",
    ...
    "Select current industry": "Unternehmen ausw\u00e4hlen",
    ...
    "Select guardian education": "Betreuerausbildung ausw\u00e4hlen",
    "Select income": "Einkommen ausw\u00e4hlen",
    "Select language": "W\u00e4hlen Sie eine Sprache",
    "Select level of education": "Bildungsstatus ausw\u00e4hlen",
    "Select military status": "Milit\u00e4rstatus ausw\u00e4hlen",
    "Select one or more groups:": "W\u00e4hlen Sie eine oder mehrere Gruppen aus:",
    "Select prospective industry": "Zuk\u00fcnftige Branche ausw\u00e4hlen",
    ...
    "Show Comment (%(num_comments)s)": [
      "Kommentar zeigen (%(num_comments)s)",
    ...
    "Showing all responses": "Alle Antworten anzeigen",
    ...
    "Starts: %(start_date)s": "Start: %(start_date)s",
    "State": "Zustand",
    "Status": "Status",
    ...
    "Subject": "Betreff",
    "Subject:": "Betreff:",
    "Submission aborted! Sorry, your browser does not support file uploads. If you can, please use Chrome or Safari which have been verified to support file uploads.": "Vorgang abgebrochen! Ihr Browser unterst\u00fctzt leider keinen Dateiupload. Benutzen Sie bitte Chrome oder Safari. Diese Browser sind erfahrungsgem\u00e4\u00df f\u00fcr den Dateiupload geeignet.",
    "Submit": "Einreichen",
    ...
    "Support education research by providing additional information": "Helfen Sie uns, unsere Lernplattform zu verbessern, indem Sie uns weitere Informationen zur Verf\u00fcgung stellen. ",
    ...
    "Thank you! You\u2019re helping make edX better for everyone.": "Danke, dass Sie edX helfen besser zu werden.",
    ...
    "The URL you entered seems to be an email address. Do you want to add the required mailto: prefix?": "Die eingegebene URL scheint eine E-Mail-Adresse zu sein. M\u00f6chten Sie den Prefix mailto: hinzuf\u00fcgen?",
    "The URL you entered seems to be an external link. Do you want to add the required http:// prefix?": "Die eingegebene URL scheint ein externer Link zu sein. M\u00f6chten Sie den Prefix http:// hinzuf\u00fcgen?",
    ...
    "The grading process is still running. Refresh the page to see updates.": "Die Bewertung l\u00e4uft noch. Laden Sie die Seite neu, um Aktualisierungen zu sehen.",
    ...
    "There was an error when trying to add learners:": [
      "Es ist ein Fehler aufgetreten, bei dem Versuch, Teilnehmer hinzuzuf\u00fcgen.",
      "{numErrors} Teilnehmer k\u00f6nnen nicht diesem Kohort zugef\u00fcgt werden:"
    ],
    ...
    "This special exam has been released to learners. You may not convert it to another type of special exam. You may revert this subsection back to being a basic exam by selecting 'None', but you will NOT be able to configure it as a special exam in the future.": "Diese Sonderpr\u00fcfung wurde f\u00fcr die Teilnehmer ver\u00f6ffentlicht und kann nicht in eine andere Art von Sonderpr\u00fcfung umgewandelt werden. Dieser Unterabschnitt kann jedoch wieder in eine Basispr\u00fcfung umgewandelt werden, indem Sie \"None\" w\u00e4hlen. Sie k\u00f6nnen die Pr\u00fcfung in Zukunft NICHT mehr als Sonderpr\u00fcfung konfigurieren.",
    "This subsection was released to learners as a special exam, but was reverted back to a basic exam. You may not configure it as a special exam now. Contact edX Support for assistance.": "Dieser Unterabschnitt wurde f\u00fcr die Teilnehmer als Sonderpr\u00fcfung ver\u00f6ffentlicht, anschlie\u00dfend aber wieder zu einer Grundpr\u00fcfung zur\u00fcckgewandelt. Die Pr\u00fcfung kann jetzt nicht mehr als Sonderpr\u00fcfung konfiguriert werden. Wenden Sie sich zur Unterst\u00fctzung an den edX-Support.",
    ...
    "Transcript Languages": "Protokollsprache",
    "Transcript Provider": "Transkriptanbieter",
    "Transcript Turnaround": "Transkript Wendepunkt",
    "Transcript will be displayed when you start playing the video.": "Das Transkript wird angezeigt, sobald Sie das Video abspielen.",
    ...
    "Updating with latest library content": "Mit den neuesten Bibliotheken aktualisieren",
    "Upgrade All Remaining Courses (": "Upgraden Sie alle \u00fcbrigen Kurse (",
    "Upgrade Deadline": "Verl\u00e4ngere Abgabetermin",
    "Upgrade to Verified": "Upgrade auf verifizierten Modus",
    ...
    "Used in {count} location": [
      "Benutzt an {count} Stelle",
      "Benutzt an {count} Stellen"
    ],
    ...
    "Verified": "Gepr\u00fcft",
    "Verified Certificate": "Beglaubigtes Zertifikat ",
    ...
    "We use your verification photos to confirm your identity and ensure the validity of your certificate.": "Wir nutzen Ihre Fotos , um Ihre Identit\u00e4t zu best\u00e4tigen und die G\u00fcltigkeit Ihres Zertifikates sicher zu stellen.",
    ...
    "Welcome to edX! Before you get started, please take a few minutes to fill-in the additional information below to help us understand a bit more about your background. You can always edit this information later in Account Settings.": "Willkommen bei edX! Bevor Sie loslegen, nehmen Sie sich bitte ein paar Minuten Zeit, um die zus\u00e4tzlichen Informationen unten auszuf\u00fcllen, damit wir ein wenig mehr \u00fcber Ihren Hintergrund erfahren. Sie k\u00f6nnen diese Informationen sp\u00e4ter in den Kontoeinstellungen jederzeit bearbeiten.",
    ...
    "What is your gender identity?": "Was ist Ihr Geschlecht?",
    ...
    "Which of the following describes you best?": "Was der folgenden Auswahlm\u00f6glichkeiten beschreibt Sie am ehesten?",
    ...
    "Why activate?": "Warum muss ich meinen Account aktivieren?",
    ...
    "You did not submit the required files: {requiredFiles}.": "Folgende Dateien wurden noch nicht eingereicht: {requiredFiles}.",
    ...
    "You have unsaved changes are you sure you want to navigate away?": "Es gibt ungespeicherte \u00c4nderungen. M\u00f6chten Sie wirklich die Seite verlassen?",
    ...
    "You submitted {filename}; only {allowedFiles} are allowed.": "Sie haben die Datei {filename} eingereicht; Es sind nur {allowedFiles} Dateien erlaubt.",
    ...
    "Your browser doesn't support direct access to the clipboard. Please use the Ctrl+X/C/V keyboard shortcuts instead.": "Ihr Browser unterst\u00fctzt keinen direkten Zugriff auf die Zwischenablage. Bitte nutzen Sie stattdessen den Tastaturk\u00fcrzel Strg+X/C/V.",
    ...
    "{numMoved} learner was moved from {prevCohort}": [
      "{numMoved} Teilnehmer wurde von dem Kohort {prevCohort} bewegt.",
      "{numMoved} Teilnehmer wurden von dem Kohort {prevCohort} bewegt."
    ],
    "{numPreassigned} learner was pre-assigned for this cohort. This learner will automatically be added to the cohort when they enroll in the course.": [
      "{numPreassigned} Teilnehmer wurde f\u00fcr diesen Kohort vorab zugewiesen. Diese Teilnehmer werden automatisch zu dem Kohort hinzugef\u00fcgt, wenn sie sich f\u00fcr den Kurs anmelden.",
      "{numPreassigned} Teilnehmer wurden f\u00fcr diese Kohorte vorab zugewiesen. Diese Teilnehmer werden automatisch zu dem Kohort hinzugef\u00fcgt, wenn sie sich f\u00fcr den Kurs anmelden."
    ],
    "{numPresent} learner was already in the cohort": [
      "{numPresent} Teilnehmer war bereits in dem Kohort",
      "{numPresent} Teilnehmer waren bereits in diesem Kohort."
    ],
    ...
    "{numUsersAdded} learner has been added to this cohort. ": [
      "{numUsersAdded} Teilnehmer wurde dem Kohort zugef\u00fcgt.",
    ...
    "{start_strong}{total}{end_strong} words submitted in total.": "{start_strong}{total}{end_strong} W\u00f6rter insgesamt.",
