...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Amount": "Cantidad", 
    "An email has been sent to {userEmail} with a link for you to activate your account.": "Un correo electr\u00f3nico ha sido enviado a su {userEmail} con un enlace para activar su cuenta.", 
    ...
    "Editable": "Editable", 
    "Editing access for: %(title)s": "Editando el acceso para: %(title)s", 
    ...
    "To finalize course credit, %(display_name)s requires %(platform_name)s learners to submit a credit request.": "Para finalizar el proceso de cr\u00e9dito, %(display_name)s requiere que los estudiantes de %(platform_name)s env\u00eden una solicitud de cr\u00e9dito.", 
    ...
    "We've sent a confirmation message to {new_secondary_email_address}. Click the link in the message to update your secondary email address.": "Hemos enviado un mensaje de confirmaci\u00f3n a {new_secondary_email_address}. Hacer clic en el enlace del mensaje para actualizar tu correo electr\u00f3nico secundario.", 
    ...
    "You may access your account when single-sign on is not available.": "Puede acceder a su cuenta cuando el inicio de sesi\u00f3n \u00fanico SSO no est\u00e1 disponible.", 
