...
(function (globals) {
  ...
  django.catalog = {
    ...
    "\n        A new window will open. You will run a system check before downloading the proctoring application.\n      ": "\nUna nueva ventana abrir\u00e1. Ud. iniciar\u00e1 un chequeo del sistema antes de descargar la aplicaci\u00f3n de supervisi\u00f3n.", 
    ...
    "\n      Because the due date has passed, you are no longer able to take this exam.\n    ": "\nPor haber pasado la fecha l\u00edmite, Ud. ya no puede tomar este examen.", 
    ...
    "\n      You are eligible to purchase academic credit for this course if you complete all required exams\n      and also achieve a final grade that meets the credit requirements for the course.\n    ": "\nUd. ser\u00e1 eligible para comprar cr\u00e9dito acad\u00e9mico en este curso si completa todos los ex\u00e1menes requeridos\ny si tambi\u00e9n logra una calificaci\u00f3n final que cumpla con los requisitos para cr\u00e9dito en este curso.", 
    ...
    "\n      You have submitted this practice proctored exam\n    ": "\nUd. ha enviado este examen de pr\u00e1ctica supervisado", 
    "\n      You have submitted this proctored exam for review\n    ": "\nUd. ha enviado este examen supervisado para revisi\u00f3n", 
    "\n      Your grade for this timed exam will be immediately available on the <a href=\"%(progress_page_url)s\">Progress</a> page.\n    ": "\nSu calificaci\u00f3n de este examen cronometrado ser\u00e1 disponible inmediatamente en la <a href=\"%(progress_page_url)s\">p\u00e1gina de progreso</a>.", 
    ...
    "\n    The following prerequisites are in a <strong>pending</strong> state and must be successfully completed before you can proceed:\n    ": "\nLos requisitos siguientes est\u00e1n en un estado <strong>pendiente</strong> y tienen que ser cumplidos exitosamente antes de que Ud. pueda proceder:", 
    "\n    You can take this exam with proctoring only when all prerequisites have been successfully completed. Check your <a href=\"%(progress_page_url)s\">Progress</a>  page to see if prerequisite results have been updated. You can also take this exam now without proctoring, but you will not be eligible for credit.\n    ": "\nUd. puede hacer este examen con supervisi\u00f3n solamente una vez que haya cumplido todos los requisitos. Revise su <a href=\"%(progress_page_url)s\">p\u00e1gina de progreso</a> para ver si los resultados de los requisitos han sido actualizados. Tambi\u00e9n se puede hacer este examen ahora sin supervisi\u00f3n, pero Ud. no ser\u00e1 elegible para cr\u00e9dito acad\u00e9mico.", 
    "\n    You did not satisfy the following prerequisites:\n    ": "\nUd. no cumpli\u00f3 los siguientes prerrequisitos:", 
    "\n    You did not satisfy the requirements for taking this exam with proctoring, and are not eligible for credit. See your <a href=\"%(progress_page_url)s\">Progress</a> page for a list of requirements and your status for each.\n    ": "\nUd. no cumpli\u00f3 los requisitos para hacer este examen con supervisi\u00f3n, y no es elegible para cr\u00e9dito. Revise su <a href=\"%(progress_page_url)s\">p\u00e1gina de progreso</a> para ver una lista de los requisitos y su estado para cada uno.", 
    "\n    You have not completed the prerequisites for this exam. All requirements must be satisfied before you can take this proctored exam and be eligible for credit. See your <a href=\"%(progress_page_url)s\">Progress</a> page for a list of requirements in the order that they must be completed.\n    ": "\nUd. no cumpli\u00f3 los requisitos para hacer este examen con supervisi\u00f3n, y no es elegible para cr\u00e9dito. Hay que cumplir todos los requisitos para poder hacer este examen supervisado y para ser elegible para cr\u00e9dito. Revise su <a href=\"%(progress_page_url)s\">p\u00e1gina de progreso</a> para una lista de los requisitos y el orden en que se tiene que cumplir cada uno.", 
    " From this point in time, you must follow the <a href=\"%(link_urls.online_proctoring_rules)s\" target=\"_blank\">online proctoring rules</a> to pass the proctoring review for your exam. ": "De ahora en adelante, Ud. tiene que seguir las <a href=\"%(link_urls.online_proctoring_rules)s\" target=\"_blank\">reglas de supervisi\u00f3n en l\u00ednea</a> para aprobar la revisi\u00f3n de supervisi\u00f3n para su examen.", 
    ...
    "Access to some content in this unit is restricted to specific groups of learners.": "El acceso a ciertos contenidos en esta unidad est\u00e1 restringido a grupos espec\u00edficos de estudiantes.", 
    ...
    "Please check your email to confirm the change": "Por favor revisa tu correo para confirmar el cambio", 
    ...
    "The email address you use to sign in. Communications from {platform_name} and your courses are sent to this address.": "La direcci\u00f3n de correo que usas para iniciar sesi\u00f3n. Las comunicaciones de {platform_name} y las relacionadas con tus cursos ser\u00e1n enviadas a esta direcci\u00f3n.", 
    "The email address you use to sign in. Communications from {platform_name} and your courses are sent to this address.  To change the email address, please contact {contact_email}.": "La direcci\u00f3n de correo que usa para iniciar sesi\u00f3n. Las comunicaciones entre {platform_name} y su curso son enviadas a esta direcci\u00f3n.  Para modificar la direcci\u00f3n de correo electr\u00f3nico, por favor contacte {contact_email}.", 
    ...
    "The name that identifies you throughout {platform_name}. You cannot change your username.": "El nombre que te identifica en el sitio de {platform_name}. No podr\u00e1 ser cambiado.", 
    "The name that is used for ID verification and appears on your certificates. Other learners never see your full name. Make sure to enter your name exactly as it appears on your government-issued photo ID, including any non-Roman characters.": "Nombre que se usar\u00e1 para la verificaci\u00f3n de identidad y que aparece en tus certificados. Otros estudiantes nunca ver\u00e1n tu nombre completo. Aseg\u00farate de que ingresas el nombre exactamente como aparece en tu identificaci\u00f3n oficial con foto, incluyendo cualquier car\u00e1cter no romano.", 
    ...
    "To pass this exam, you must complete the problems in the time allowed.": "Para aprobar este examen, hay que completar las problemas durante el tiempo permitido.", 
    ...
    "We weren't able to send you a password reset email.": "No se ha podido enviar el correo para restablecer tu contrase\u00f1a.", 
    ...
    "When you select \"Reset Your Password\", a message will be sent to the email address for your {platform_name} account. Click the link in the message to reset your password.": "Cuando seleccionas \"Restablecer tu contrase\u00f1a\", un mensaje ser\u00e1 enviado a la direcci\u00f3n de correo electr\u00f3nico asociada con tu cuenta de {platform_name}. Haz clic en el v\u00ednculo del mensaje para restablecer tu contrase\u00f1a. ", 
    ...
    "You are taking \"{exam_link}\" as a {exam_type} exam. The timer on the right shows the time remaining in the exam.": "Est\u00e1 tomando el examen \"{exam_link}\". Este es un examen {exam_type}. El cron\u00f3metro a la derecha muestra el tiempo restante para terminar la prueba.", 
    ...
    "You have added a criterion. You will need to select an option for the criterion in the Learner Training step. To do this, click the Settings tab.": "Has agregado un criterio. Necesitar\u00e1s seleccionar una opci\u00f3n par este en el entrenamiento de estudiantes. Para hacer esto, vaya a Configuraciones.", 
    ...
    "You have deleted a criterion. The criterion has been removed from the example responses in the Learner Training step.": "Has borrado un criterio. El criterio ha sido removido de los ejemplos de respuesta en el entrenador de estudiantes.", 
    "You have deleted all the options for this criterion. The criterion has been removed from the sample responses in the Learner Training step.": "Has eliminado todas las opciones para este criterio. El criterio ha sido eliminado del las respuestas ejemplo en el entrenamiento.", 
    "You have deleted an option. That option has been removed from its criterion in the sample responses in the Learner Training step. You might have to select a new option for the criterion.": "Has borrado esta opci\u00f3n. Esta opci\u00f3n ha sido eliminada del criterio en el ejemplo de respuestas en el entrenamiento de estudiantes. Puedes seleccionar una nueva opci\u00f3n para el criterio.", 
