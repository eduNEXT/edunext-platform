...
DATA_API_DEF_PAGE_SIZE = ENV_TOKENS.get('DATA_API_DEF_PAGE_SIZE', DATA_API_DEF_PAGE_SIZE)
DATA_API_MAX_PAGE_SIZE = ENV_TOKENS.get('DATA_API_MAX_PAGE_SIZE', DATA_API_MAX_PAGE_SIZE)
...
##### Microsite API #####
MICROSITE_API_ALLOWED_REMOTES = ENV_TOKENS.get('MICROSITE_API_ALLOWED_REMOTES', [])
MICROSITE_API_SIGNING_KEY = AUTH_TOKENS.get('MICROSITE_API_SIGNING_KEY', "")
MICROSITE_API_MANAGER = ENV_TOKENS.get('MICROSITE_API_MANAGER', None)
