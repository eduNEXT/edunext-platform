...
from lms.djangoapps.experiments.testutils import override__coursewaffleflag_flag
...
class ShowAnswerFieldOverrideTest(ModuleStoreTestCase):
    ...
    def test_override_enabled_for(self, active):
        with override__coursewaffleflag_flag(RELATIVE_DATES_FLAG, active=active):
    ...
    @ddt.unpack
    @override__coursewaffleflag_flag(RELATIVE_DATES_FLAG, active=True)
