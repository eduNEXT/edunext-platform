...
from openedx_filters.learning.filters import StudentRegistrationRenderStarted
...
class RegistrationFormFactory:
    ...
    def get_registration_form(self, request):
        ...
        try:
            form_desc = StudentRegistrationRenderStarted().run_filter(form_desc=form_desc)
