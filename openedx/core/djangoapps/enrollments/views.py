...
from lms.djangoapps.courseware.courses import get_course  # lint-amnesty, pylint: disable=wrong-import-order
from lms.djangoapps.courseware.models import StudentModule, BaseStudentModuleHistory  # lint-amnesty, pylint: disable=wrong-import-order
