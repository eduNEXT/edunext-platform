...
(function(globals) {
  ...
  var newcatalog = {
    ...
    " learner encountered an unknown error": "El estudiante encontr\u00f3 un error desconocido",
    ...
    "Create a report of problem responses": "Crea un reporte de respuesta de problemas",
    ...
    "Enter your {platform_display_name} username or the URL to your {platform_display_name} page. Delete the URL to remove the link.": "Entra tu nombre de usuario {platform_display_name}  o la URL de tu pagina {platform_display_name}. Borra la URL para remover el enlace.",
    ...
    "No assignments for team": "No hay asignaciones para el equipo",
    "No color": "Sin color",
    ...
    "Select military status": "Selecciona estatus militar",
    ...
    "Team Assignments": "Tareas del equipo",
    ...
    "There was an error in setting your goal, please reload the page and try again.": "Ocurri\u00f3 un error estableciendo su objetivo, por favor recargue la p\u00e1gina e intente de nuevo.",
