...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Thank you {full_name}! We have received your payment for {course_name}.": "Danke {full_name}! Wir haben Ihre Bezahlung f\u00fcr den Kurs {course_name} erhalten.",
    ...
    "To finalize course credit, {display_name} requires {platform_name} learners to submit a credit request.": "Um Kursgutschriften zu erhalten, {display_name} m\u00fcssen Teilnehmer der {platform_name} einen Kreditantrag einreichen.",
    ...
    "You still need to visit the {display_name} website to complete the credit process.": "Sie m\u00fcssen noch die Website {display_name} besuchen, um den Credit-Prozess abzuschlie\u00dfen.",
