...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Only <%- fileTypes %> files can be uploaded. Please select a file ending in <%- (fileExtensions) %> to upload.": "Seuls les fichiers <%- fileTypes %> peuvent \u00eatre t\u00e9l\u00e9vers\u00e9s. Veuillez s\u00e9lectionner un fichier se terminant par <%- (fileExtensions) %> pour le t\u00e9l\u00e9verser.",
